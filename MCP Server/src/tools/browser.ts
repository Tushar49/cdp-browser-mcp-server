  ...
  registry.register(
    defineTool({
      ...
      description: [
        ...
        '',
        'Operations:',
        "- profiles: List all detected browser instances with their profiles, ports, and connection status. If you're not connected, just call any tool — the server auto-connects. You only need this to switch between browsers.",
